...
const InformationPage = () => {
  return (
    <section className="w-full h-full relative">
      ...
      <div className="lg:max-h-screen w-full h-full grid grid-cols-1 grid-rows-[auto,_auto,_auto,_auto,_300px] lg:grid-cols-3 lg:grid-rows-[auto,_2fr,_1fr] lg:gap-4 gap-y-4 ">
        <Navbar />
